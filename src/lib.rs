    ...
    rocket::ignite()
        .mount(
            ...
            routes![
                ...
                routes::products::recent,
                routes::products::popular,
                routes::tags::get_all,
                routes::s3::upload,
                routes::reactions::add_react,
                routes::reactions::sub_react,
                routes::reactions::get_by_user_id,
                routes::suggestions::suggestion,
            ],
        )
        .attach(cors)
